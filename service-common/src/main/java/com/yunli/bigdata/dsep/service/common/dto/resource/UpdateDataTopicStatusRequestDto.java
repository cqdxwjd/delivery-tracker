 ...
 * @author wei
 */
@ApiModel(description = "修改TOPIC状态的参数对象")
public class UpdateDataTopicStatusRequestDto implements Serializable {
  ...
  public UpdateDataTopicStatusRequestDto() {
  }

  public UpdateDataTopicStatusRequestDto(List<Long> id, String reason, Integer status, Boolean stopJobs) {
    this.id = id;
    this.reason = reason;
    this.status = status;
  ...
  @ApiModelProperty(value = "是否停止对应TOPIC已启用的作业")
