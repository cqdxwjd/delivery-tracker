...
public class UpdateDocumentRequest implements Serializable {
  ...
  public UpdateDocumentRequest(String name, String responsibleOrganizationId, String responsibleId, Integer sharingType,
      String sharingCondition, String description, List<LabelInfo> labels, String reason, Boolean allowSameName) {
    this.name = name;
