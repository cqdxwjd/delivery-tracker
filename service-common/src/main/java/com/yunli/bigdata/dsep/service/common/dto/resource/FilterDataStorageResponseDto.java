 ...
 * @author wei
 */
@ApiModel(description = "数据存储信息信息查询结果对象")
public class FilterDataStorageResponseDto implements Serializable {
  ...
  public FilterDataStorageResponseDto() {
  }

  public FilterDataStorageResponseDto(Long id, String storageName, String storageType, String connection,
